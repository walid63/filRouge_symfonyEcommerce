...
class AnnonceController extends AbstractController
{
    ...
    public function index(AnnonceRepository $annonceRepository,UserRepository $userRepos): Response
    {
        $title = "liste global des annonces";
    ...
    {
        $title = "Crée une nouvelle annonce";
        $titlePage = ucwords($title);
